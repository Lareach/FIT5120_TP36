var nodeData = {
    "solarPanels": {
        ...
        description: "<p><strong>Money-Saving Tips:</strong></p>" +
            ...
            "<a href='https://www.solar.vic.gov.au/solar-panel-rebate' target='_blank'>Solar Panel Rebate</a>"
        ,
    ...
    "outdoorlighting": {
        ...
        description: "<p><strong>Money-Saving Tips:</strong></p>" +
            ...
            "<p><strong>Governmental Support:</strong></p>" +
            "<a href='https://www.solar.vic.gov.au/solar-rebates' target='_blank'>Solar Rebates</a>"
        ,
    ...
    "evcharger": {
        ...
        description: "<p><strong>Money-Saving Tips:</strong></p>" +
            ...
            "</ul>" +
            "<p><strong>Governmental Support:</strong></p>" +
            "<a href='https://www.solar.vic.gov.au/getting-your-home-ev-ready' target='_blank'>Getting Your Home EV Ready</a>"
        ,
