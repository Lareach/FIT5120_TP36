...
public class Questionnaire1Controller : Controller
{
    ...
    public Questionnaire1Controller(SavingsContext context)
    {
        _context = context;
    }
    ...
    {
        return View("~/Views/Iteration1/Questionnaire/Index.cshtml");
    }
    ...
    public async Task<IActionResult> Results()
    {
        ...
        return View("~/Views/Iteration1/Questionnaire/Results.cshtml", InferBenefits(utilityBills, propertyOwnership, householdIncome, concessionCards));
    }
